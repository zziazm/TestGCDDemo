...
- (void)cleanDisk
{
    dispatch_async(self.ioQueue, ^
    {
        NSDate *theexpirationDate = [NSDate dateWithTimeIntervalSinceNow:-self.maxCacheAge];
        ...
        for (NSURL *fileURL in fileEnumerator)
        {
            ...
            if ([[fileModificationDate laterDate:theexpirationDate] isEqualToDate:theexpirationDate])
            {
